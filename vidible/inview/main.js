(function () {
    ...
    amplify.request.define("aol.videogroup", "ajax", {
        url: "http://api.5min.com/video/list//info.json?sid=577&num_of_videos=100&video_group_id={vg}",
        dataType: "jsonp",
        method: "GET",
        cache: true
    });
    ...
    var videoGroup = Number($(".videoWidget").attr('data-videogroup'));  //157522;
    //'157522'/*'157520'*/

    amplify.request({
        resourceId: "aol.videogroup",
            data: {
                search: searchTerm,
                vg: videoGroup
            },
